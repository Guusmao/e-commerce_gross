  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="flex flex-col w-full max-w-full">
        ...
        <p className="text-primary text-xl sm:text-2xl font-bold mb-1">R$ {product.price.toFixed(2)}</p>
        ...
        <button
          ...
          className={`w-full text-center font-semibold text-white py-3 rounded-md transition-colors text-sm sm:text-base ${
            added ? 'bg-green-600 hover:bg-green-700' : 'bg-primary hover:brightness-110'
          }`}
        >
