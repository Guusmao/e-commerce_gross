        ...
        return (
          ...
          >
            ...
            <div className="p-2 flex flex-col flex-grow">
              ...
              <h3 className="text-base font-semibold text-gray-800 mt-1 mb-1 flex-grow">
                {product.name}
              </h3>
            ...
            <div className="px-2 pb-2">
              ...
              <Link
                ...
                className="block w-full text-center bg-gray-200 text-gray-700 font-semibold py-1.5 text-sm rounded-lg hover:bg-gray-300 transition"
              >
                Ver mais
              </Link>
            </div>
